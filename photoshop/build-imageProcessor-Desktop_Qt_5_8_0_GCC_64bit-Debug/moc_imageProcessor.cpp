...
void ImageProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ImageProcessor::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageProcessor::finished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ImageProcessor::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageProcessor::progress)) {
                *result = 1;
                return;
            }
        }
